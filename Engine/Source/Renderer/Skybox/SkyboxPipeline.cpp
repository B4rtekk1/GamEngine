...
namespace Engine {
    ...
    void SkyboxPipeline::create(VkDevice device, VkFormat colorFormat, VkFormat depthFormat, VkSampleCountFlagBits samples,
        ...
        try {
            ...
            if (vkCreatePipelineLayout(device_, &layout, nullptr, &layout_) != VK_SUCCESS) {
                throw std::runtime_error(
                    "Could not create skybox pipeline layout");
            }
            ...
            color.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT |
    ...
    void SkyboxPipeline::destroy() noexcept {
