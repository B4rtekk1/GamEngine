...
namespace Engine {
    ...
    public:
        ...
        /**
         * Version 23 persists WaterBodyComponent geometry, optical parameters and Gerstner waves. Version 21 adds local ReflectionProbeComponent volumes. Version 19 persists a material's relative Shader Graph source asset;
         ...
         */
        static constexpr std::uint32_t FormatVersion = 23;
